...
/*** Creating URL for Account Deletion ***/
$account_deletion_url = "/request-account-deletion/";
$account_deletion_url .= "?user-name=" . urlencode($user->first_name . " " . $user->last_name);
$account_deletion_url .= "&email=" . urlencode($user->user_email);
$account_deletion_url .= "&id=" . urlencode(get_current_user_id());
?>
        ...
        <div class="dokan-dashboard-content">
            ...
            ?>
                ...
                <article class="dashboard-content-area woocommerce edit-account-wrap">
                    ...
                    <a href="<?= home_url()?><?= $account_deletion_url ?>" class="dokan-btn dokan-btn-danger">
                      <?php esc_attr_e( 'Delete Your Account', 'dokan-lite' ); ?>
                    </a>
