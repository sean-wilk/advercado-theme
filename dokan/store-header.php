...
$is_store_featured = $store_user->is_featured();

$vendor_status = get_field('vendor_status', 'user_'. $store_user->get_id() );
$is_store_founder = false;

if($vendor_status == "founder"){
  $is_store_founder = true;
}
                    ...
                    <div class="profile-info">
                        <div class="profile-info-top">
                          ...
                          <div class="featured-favourite">
                              ...
                              <?php endif ?>
                              <?php if ( $is_store_founder ) : ?>
                                  <div class="founder-label"><?php esc_html_e( 'Founder', 'dokan-lite' ); ?></div>
                              <?php endif ?>
