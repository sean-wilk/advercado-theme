 ...
 * @package dokan
 *
 * Changes: Line 837 - Changed default text for dashboard verification.
 */
class Products {
    ...
    public function dokan_pro_localized_args( $args ) {
        $dokan_pro_args = array(
            ...
            'not_enable_message'              => __( 'Verify your account in settings before you set up your store.', 'dokan' ),
        );
