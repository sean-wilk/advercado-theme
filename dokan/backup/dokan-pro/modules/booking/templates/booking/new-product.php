    ...
    if ( $can_sell ) {
        ...
        if ( dokan_is_seller_enabled( get_current_user_id() ) ) {
            ...
            <form class="dokan-product-edit-form" role="form" method="post">
                ...
                ?>
              <div id="form-accordion-top" class="form-accordion active">
              ...
              <div id="form-accordion-bottom" class="form-accordion">
                <div class='form-accordion-header'>
                ...
                <div class="form-accordion-content">
                   ...
                   <?php
                        do_action( 'dokan_booking_before_shipping', $post, $post_id );
                ...
                ?>
                    ...
                    <input type="submit" name="dokan_update_product" class="dokan-btn dokan-btn-theme dokan-btn-lg btn-block" value="<?php esc_attr_e( 'Save Product', 'dokan' ); ?>" style="margin: 32px 0;"/>
                ...
                <?php else: ?>
                    ...
                    <input type="submit" name="add_product" class="dokan-btn dokan-btn-theme dokan-btn-lg btn-block" value="<?php esc_attr_e( 'Save Product', 'dokan' ); ?>" style="margin: 32px 0;"/>
