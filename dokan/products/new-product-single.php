                    ...
                    if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                        <form class="dokan-product-edit-form" role="form" method="post">
                          ...
                          <div id="form-accordion-bottom" class="form-accordion">
                            ...
                            <input type="submit" name="dokan_update_product" class="dokan-btn dokan-btn-theme dokan-btn-lg" value="<?php esc_attr_e( 'Save Product', 'dokan-lite' ); ?>" style="margin: 32px 0;"/>
